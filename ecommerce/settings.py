...
# For PostgreSQL configuration (uncomment when using PostgreSQL):
# DATABASES = {
#     'default': {
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'A comprehensive ecommerce store API',
    'VERSION': '1.0.0',
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@ecommerce-store.com')
...
# Payment Settings
PAYMENT_TIMEOUT = config('PAYMENT_TIMEOUT', default=900, cast=int)  # 15 minutes
CURRENCY = 'usd'
